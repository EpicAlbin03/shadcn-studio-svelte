      ...
      <div class='border-input overflow-hidden rounded-md border'>
        ...
        >
          {listitems.map(item => (
            <ListBoxItem
              key={item.id}
              class='data-[disabled]:text-muted-foreground data-[selected]:bg-accent data-[selected]:text-accent-foreground flex items-center justify-between rounded-sm px-2 py-1.5'
