...
<HoverCard openDelay={0} closeDelay={0}>
	<HoverCardTrigger>
		{#snippet child({ props })}
			<Button {...props} variant="link">Hover Card Media</Button>
		{/snippet}
	</HoverCardTrigger>
	<HoverCardContent>
		<div class="space-y-2">
			<img src="/img/components/himalaya.jpg" alt="Content" class="w-full rounded" />
			<div class="space-y-1">
				...
				<p class="text-xs text-muted-foreground">
					...
					<a
						...
						class="flex w-fit underline hover:text-foreground"
					>
						Read more
