	...
	const items = [
		{
			...
			src: '/img/components/product-01.webp',
			fallback: 'WGC',
			color: 'Black',
			category: 'Furniture',
			price: '$269.09'
		},
		{
			...
			src: '/img/components/product-02.webp',
			fallback: 'J1R',
			color: 'Red',
			category: 'Sneakers',
			price: '$150.00'
		},
		{
			...
			model: 'OnePlus 7 Pro',
			src: '/img/components/product-03.webp',
			fallback: 'O7P',
			color: 'Nebula Blue',
			category: 'Smartphone',
			price: '$869.00'
		},
		{
			...
			src: '/img/components/product-04.webp',
			fallback: 'NS',
		...
		},
		{
			...
			src: '/img/components/product-05.webp',
			fallback: 'AMM',
			color: 'Black',
