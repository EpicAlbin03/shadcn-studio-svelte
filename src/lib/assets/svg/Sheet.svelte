...
<svg width="278" height="191" viewBox="0 0 278 191" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
  ...
  <path d="M277 167L0.999999 167" stroke="url(#paint3_linear_16511_23622)" stroke-opacity="0.4" />
  <rect x="165.688" y="23" width="88.5502" height="144" rx="8" fill="var(--card)" />
  <rect x="175.209" y="36.5" width="47.4371" height="8" rx="4" fill="var(--card-foreground)" fill-opacity="0.2" />
  ...
  <rect x="175.209" y="72.5" width="24.095" height="8" rx="4" fill="var(--card-foreground)" fill-opacity="0.2" />
  <rect x="175.209" y="90.5" width="43.6722" height="8" rx="4" fill="var(--card-foreground)" fill-opacity="0.2" />
  <defs>
    <linearGradient
