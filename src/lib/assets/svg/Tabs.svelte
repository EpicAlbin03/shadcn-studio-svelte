...
<svg width="220" height="57" viewBox="0 0 220 57" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
  <g clip-path="url(#clip0_5372_59611)">
    ...
    <rect x="151" y="25" width="38" height="6" rx="3" fill="var(--card-foreground)" fill-opacity="0.6" />
    ...
    <rect x="31" y="25" width="38" height="6" rx="3" fill="var(--card-foreground)" fill-opacity="0.6" />
  </g>
  <defs>
    <linearGradient
