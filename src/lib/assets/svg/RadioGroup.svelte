...
<svg width="116" height="103" viewBox="0 0 116 103" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
  <g clip-path="url(#clip0_5515_6726)">
    <rect x="30" y="23" width="56" height="56" rx="28" fill="var(--card)" />
    <rect x="42" y="35" width="32" height="32" rx="16" fill="var(--primary)" />
