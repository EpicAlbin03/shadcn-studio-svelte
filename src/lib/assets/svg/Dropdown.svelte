...
<svg width="178" height="152" viewBox="0 0 178 152" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
  <g clip-path="url(#clip0_5357_51872)">
    ...
    <rect x="31" y="50" width="86" height="8" rx="4" fill="var(--card-foreground)" fill-opacity="0.2" />
    <rect x="31" y="71" width="118" height="8" rx="4" fill="var(--primary)" />
    <rect x="31" y="92" width="43" height="8" rx="4" fill="var(--card-foreground)" fill-opacity="0.2" />
    <rect x="31" y="113" width="79" height="8" rx="4" fill="var(--card-foreground)" fill-opacity="0.2" />
