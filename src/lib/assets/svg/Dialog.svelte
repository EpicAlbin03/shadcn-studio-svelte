...
<svg width="230" height="150" viewBox="0 0 230 150" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
  <g clip-path="url(#clip0_5357_51857)">
    ...
    <rect x="86" y="102" width="50" height="18" rx="4" fill="var(--card-foreground)" fill-opacity="0.2" />
    <rect x="39" y="58" width="143" height="8" rx="4" fill="var(--card-foreground)" fill-opacity="0.2" />
    <rect x="39" y="72" width="100" height="8" rx="4" fill="var(--card-foreground)" fill-opacity="0.2" />
  </g>
  <defs>
    <linearGradient
