...
<svg width="208" height="110" viewBox="0 0 208 110" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
  <g clip-path="url(#clip0_5515_4681)">
    ...
    <rect x="31" y="50" width="104" height="8" rx="4" fill="var(--card-foreground)" fill-opacity="0.2" />
  ...
  <defs>
    <linearGradient id="paint0_linear_5515_4681" x1="18.5" y1="22" x2="18.4909" y2="110" gradientUnits="userSpaceOnUse">
