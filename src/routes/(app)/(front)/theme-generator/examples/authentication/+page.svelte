<script lang="ts">
	import UserAuthForm from '$lib/components/examples/authentication/components/UserAuthForm.svelte';
...
<div
	class="relative container hidden h-200 flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0"
>
	<Button
