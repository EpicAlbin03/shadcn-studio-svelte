<script lang="ts">
	import DataTable from '$lib/components/examples/tasks/components/DataTable.svelte';
	import UserNav from '$lib/components/examples/tasks/components/UserNav.svelte';
	import { data } from '$lib/components/examples/tasks/data/tasks.js';
</script>
